...
slug: "reference/compiler/0.1.0/reference/m3-ownership-composition"
---

> Verified compiler source: [docs/M3_OWNERSHIP_COMPOSITION.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_OWNERSHIP_COMPOSITION.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
public profile or target execution is enabled. The [evidence matrix](/reference/compiler/0.1.0/reference/m3-ownership-composition-evidence/)
separates existing declarations/tests from proposed interfaces and future proofs.

Later #278 candidate extensions are documented in [generic function operations](/reference/compiler/0.1.0/reference/m3-generic-function-operations/),
[structural clone](/reference/compiler/0.1.0/reference/m3-generic-clone-core/), and [generic Vec operations](/reference/compiler/0.1.0/reference/m3-generic-vec-operations/).
...
The normative authorities are [data ownership](/reference/compiler/0.1.0/reference/data-ownership-v1/), sections
2–12, and [ownership runtime ABI](/reference/compiler/0.1.0/reference/ownership-runtime-v1/), sections 2–8.
The [Shared/Weak contract](/reference/compiler/0.1.0/reference/m3-shared-weak-authority/) owns SW1–SW5 and handle meanings;
...
See the [candidate evidence and remaining scope](/reference/compiler/0.1.0/reference/m3-ownership-composition-evidence/) rather than
...
[#271 closure matrix](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_STRUCTURED_OWNED_CONTROL_FLOW_MATRIX.md) now binds the complete C7 source
...
continuation contract in [M3\_TRANSIENT\_INDEXED\_ACCESS.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_TRANSIENT_INDEXED_ACCESS.md).
