...
[C1–C4](/reference/compiler/0.1.0/reference/m3-ownership-composition/). It does not close #278, provide #255/#256 indexed source
...
after its signed bounds check; see [generic Vec operations](/reference/compiler/0.1.0/reference/m3-generic-vec-operations/).
