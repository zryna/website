...
[manifest v2](/reference/compiler/0.1.0/reference/m2-manifest-v2/). Issue #56 implements the fixed three-target oracle and required
[aggregate gate](/reference/compiler/0.1.0/reference/m2-conformance/). Issue #57 records authenticated website import, deployment,
