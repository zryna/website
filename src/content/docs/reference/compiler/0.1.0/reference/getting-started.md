...
slug: "reference/compiler/0.1.0/reference/getting-started"
---

> Verified compiler source: [docs/GETTING_STARTED.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/GETTING_STARTED.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[Your first M3 programs](/reference/compiler/0.1.0/reference/m3-getting-started/). Run commands from the compiler repository root.
...
[accepted control flow](/reference/compiler/0.1.0/reference/m2-control-flow-semantics/#accepted-control-flow) and
[module rules](/reference/compiler/0.1.0/reference/m2-module-closure/) before extending the example.
...
use the unambiguous form `--arg=i32:-1`. The [CLI reference](/reference/compiler/0.1.0/reference/cli/) defines canonical spelling,
...
symlinks/reparse points in the checkout. The [strict workspace contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/STRICT_WORKSPACE.md)
...
The authoritative [target/platform table](/reference/compiler/0.1.0/reference/cli/#targets) documents JavaScript and core WebAssembly
...
See [the existing alternative-target commands](/reference/compiler/0.1.0/reference/cli/#examples) and platform prerequisites before
...
[M3 beginner guide](/reference/compiler/0.1.0/reference/m3-getting-started/); internal ownership tests do not enable that CLI profile
or replace its public tutorial. Consult the [roadmap](/reference/compiler/0.1.0/status/roadmap/) for separate capabilities.
