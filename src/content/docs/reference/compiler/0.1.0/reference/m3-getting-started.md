...
[public boundaries](/reference/compiler/0.1.0/reference/m3-public-profile/) and the
[preview policy](/reference/compiler/0.1.0/reference/developer-preview/).

## Setup

Follow the [checkout and tool installation steps](/reference/compiler/0.1.0/reference/getting-started/#prepare-the-checkout):
...
syntax and ownership combinations fail closed. The [public profile](/reference/compiler/0.1.0/reference/m3-public-profile/) gives
host/toolchain and resource boundaries; [conformance](/reference/compiler/0.1.0/reference/m3-conformance/) describes the independent
oracles and exact-limit proofs. The [M1/M2 guide](/reference/compiler/0.1.0/reference/getting-started/) remains valid unchanged.
