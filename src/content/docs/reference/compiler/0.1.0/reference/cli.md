...
slug: "reference/compiler/0.1.0/reference/cli"
---

> Verified compiler source: [docs/CLI.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/CLI.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
replaces an existing destination. See [public boundaries](/reference/compiler/0.1.0/reference/m3-public-profile/),
[manifest v3](/reference/compiler/0.1.0/reference/m3-candidate-driver/), and [executable beginner examples](/reference/compiler/0.1.0/reference/m3-getting-started/).
...
and manifest v3 are documented in [M3 driver](/reference/compiler/0.1.0/reference/m3-candidate-driver/).
...
[Package resolution](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/PACKAGE_RESOLUTION.md). It does not compile source or select a backend.
...
outside the advertised [v0.1.0 preview support matrix](/reference/compiler/0.1.0/reference/developer-preview/).
...
observations. The repository's [M1 conformance suite](/reference/compiler/0.1.0/status/m1-conformance/) compares those public
...
[M2 conformance gate](/reference/compiler/0.1.0/reference/m2-conformance/) independently compares the explicit profile against a
...
the [native executable contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/native-semantics/EXECUTABLE.md). Generated artifacts are
...
The repository-owned [M2 conformance gate](/reference/compiler/0.1.0/reference/m2-conformance/) performs fixed-oracle three-target
