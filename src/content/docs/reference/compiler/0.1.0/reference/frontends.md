...
slug: "reference/compiler/0.1.0/reference/frontends"
---

> Verified compiler source: [docs/FRONTENDS.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/FRONTENDS.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[Syntax protocol v2](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/SYNTAX_PROTOCOL_V2.md).
...
[M2 deterministic module closure](/reference/compiler/0.1.0/reference/m2-module-closure/) and specified normatively in
[scalar control flow and modules v1](/reference/compiler/0.1.0/reference/control-flow-modules-v1/). The public driver
...
[M2 straight-line semantic boundary](/reference/compiler/0.1.0/reference/m2-straight-line-semantics/) and
[control-flow extension](/reference/compiler/0.1.0/reference/m2-control-flow-semantics/), then the sealed internal
[M2 JavaScript backend](/reference/compiler/0.1.0/reference/m2-javascript-backend/) or
[M2 core WebAssembly backend](/reference/compiler/0.1.0/reference/m2-webassembly-backend/), or the independently resealed
[M2 native MIR profile](/reference/compiler/0.1.0/reference/m2-native-mir/) and its audited internal
[Linux x86-64 native backend](/reference/compiler/0.1.0/reference/m2-native-backend/). Those sealed boundaries are surfaced only
