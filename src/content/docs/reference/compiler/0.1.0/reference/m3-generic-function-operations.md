...
slug: "reference/compiler/0.1.0/reference/m3-generic-function-operations"
---

> Verified compiler source: [docs/M3_GENERIC_FUNCTION_OPERATIONS.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_GENERIC_FUNCTION_OPERATIONS.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[composition contracts](/reference/compiler/0.1.0/reference/m3-ownership-composition/), especially C1–C5. This is source-to-verified-IR
...
The checked [owned-call closure matrix](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_OWNED_CALL_CLOSURE_MATRIX.md) binds these source claims
...
The [static subobject adapters](/reference/compiler/0.1.0/reference/m3-generic-static-places/) retain exact Struct-field and constant
...
Non-handle structural clone reuses the [canonical clone core](/reference/compiler/0.1.0/reference/m3-generic-clone-core/), including
...
[Vec operation contract](/reference/compiler/0.1.0/reference/m3-generic-vec-operations/): Copy indexing, explicit owned clone,
...
The [indexed-source adapter](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_INDEXED_SOURCE_OPERATIONS.md) also admits lexical nested
