---
title: "M2 deterministic module closure"
description: "Compiler-owned 0.1.0 documentation imported from f4d28002a014."
slug: "reference/compiler/0.1.0/reference/m2-module-closure"
---

> Verified compiler source: [docs/M2_MODULE_CLOSURE.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M2_MODULE_CLOSURE.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[M2 straight-line semantic boundary](/reference/compiler/0.1.0/reference/m2-straight-line-semantics/) and its
[control-flow extension](/reference/compiler/0.1.0/reference/m2-control-flow-semantics/), then the internal
[M2 JavaScript backend](/reference/compiler/0.1.0/reference/m2-javascript-backend/),
[M2 core WebAssembly backend](/reference/compiler/0.1.0/reference/m2-webassembly-backend/), or the independently resealed
[M2 Linux x86-64 native backend](/reference/compiler/0.1.0/reference/m2-native-backend/) only through the explicit driver path.
[Manifest v2 and the atomic multi-file command](/reference/compiler/0.1.0/reference/m2-manifest-v2/) and the independent
[fixed-oracle three-target gate](/reference/compiler/0.1.0/reference/m2-conformance/) are implemented. Issue #57 records authenticated
