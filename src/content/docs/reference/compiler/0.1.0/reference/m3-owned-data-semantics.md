...
slug: "reference/compiler/0.1.0/reference/m3-owned-data-semantics"
---

> Verified compiler source: [docs/M3_OWNED_DATA_SEMANTICS.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_OWNED_DATA_SEMANTICS.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[`DATA_OWNERSHIP_V1.md`](/reference/compiler/0.1.0/reference/data-ownership-v1/). This document fixes the smaller
implementation boundary that Issue #81 proved before later target work may consume it.

The subsequent [Shared/Weak authority contract](/reference/compiler/0.1.0/reference/m3-shared-weak-authority/) freezes Issue #259's
