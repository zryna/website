...
slug: "reference/compiler/0.1.0/reference/language-overview"
---

> Verified compiler source: [spec/language/OVERVIEW.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/language/OVERVIEW.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
The implemented explicit M2 [`ControlFlowV1`](/reference/compiler/0.1.0/reference/control-flow-modules-v1/) profile freezes exact wrapping scalar
...
The specified-only [cross-target profile composition v1](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/language/CROSS_TARGET_PROFILES_V1.md) separates
...
The specified-only M4 [WIT capability contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/wit/CAPABILITY_PROFILES_V1.md) pins separate
...
The specified-only [typed JS/WASM adapter design](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/interop/JS_WASM_ADAPTERS_V1.md) separately
