---
title: "M3 Shared and Weak authority contract"
description: "Compiler-owned 0.1.0 documentation imported from f4d28002a014."
slug: "reference/compiler/0.1.0/reference/m3-shared-weak-authority"
---

> Verified compiler source: [docs/M3_SHARED_WEAK_AUTHORITY.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_SHARED_WEAK_AUTHORITY.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[evidence and integration matrix](/reference/compiler/0.1.0/reference/m3-shared-weak-evidence/). It enables no runtime, backend,
driver route, public profile, or target execution.

The normative authorities remain [data ownership](/reference/compiler/0.1.0/reference/data-ownership-v1/),
especially sections 2, 5–7, 10–12, and
[ownership runtime ABI](/reference/compiler/0.1.0/reference/ownership-runtime-v1/), especially sections 2–3 and 7–8.
...
the [evidence matrix](/reference/compiler/0.1.0/reference/m3-shared-weak-evidence/). These interfaces add no source route, wire
...
| Non-last Shared release | Consume one Shared, decrement strong only, preserve payload and weak count                                                                      | Infallible for verified input; corruption is ABI\_VIOLATION                                                                     |
| Last Shared release     | Begin1→0, reserve control; complete recursive payload drop once; finish removes implicit weak, frees control iff no explicit Weak remains       | No allocation or source callback; invalid phase/completion is ABI\_VIOLATION                                                    |
| Explicit Weak release   | Consume one explicit Weak; decrement weak; free iff no strong/implicit owner and last explicit Weak gone                                        | Never consumes implicit weak; double/stale/wrong-control release is ABI\_VIOLATION                                              |
...
| SW4 last-release completion  | One last-strong begin receipt bound to control/site; exact sealed payload drop topology, active variants and initialized masks; completed release trace          | One non-replayable finish permission, only after payload cleanup; rejects omitted/duplicate/out-of-order leaves, premature finish and forged payload\_initialized=false                                |
