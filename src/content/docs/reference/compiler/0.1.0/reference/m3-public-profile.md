---
title: "Public DataOwnershipV1 profile"
description: "Compiler-owned 0.1.0 documentation imported from f4d28002a014."
slug: "reference/compiler/0.1.0/reference/m3-public-profile"
---

> Verified compiler source: [docs/M3_PUBLIC_PROFILE.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_PUBLIC_PROFILE.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
The [beginner guide](/reference/compiler/0.1.0/reference/m3-getting-started/) contains complete sources tied to the fixed executable
corpus. The detailed [language contract](/reference/compiler/0.1.0/reference/data-ownership-v1/),
[source-completion evidence](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_SOURCE_COMPLETION.md), and
[conformance contract](/reference/compiler/0.1.0/reference/m3-conformance/) distinguish source/IR proofs from executed target cases.
...
and fail at their owning phase. The [full gate](/reference/compiler/0.1.0/reference/m3-conformance/) retains exact-limit and
