...
The detailed [M1](/reference/compiler/0.1.0/status/m1-conformance/), [M2](/reference/compiler/0.1.0/reference/m2-conformance/), and
[M3](/reference/compiler/0.1.0/reference/m3-public-profile/) contracts remain authoritative when a summary above omits a resource,
...
support for in-progress M4–M7 work. The [current status](/reference/compiler/0.1.0/status/current/) and individual profile
