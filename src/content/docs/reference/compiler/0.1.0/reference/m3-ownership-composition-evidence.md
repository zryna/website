---
title: "M3 ownership composition evidence"
description: "Compiler-owned 0.1.0 documentation imported from f4d28002a014."
slug: "reference/compiler/0.1.0/reference/m3-ownership-composition-evidence"
---

> Verified compiler source: [docs/M3_OWNERSHIP_COMPOSITION_EVIDENCE.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_OWNERSHIP_COMPOSITION_EVIDENCE.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
Read the [eight interface contracts](/reference/compiler/0.1.0/reference/m3-ownership-composition/) and
[Shared/Weak evidence](/reference/compiler/0.1.0/reference/m3-shared-weak-evidence/). Normative language/ABI authority remains
...
The [generic clone contract](/reference/compiler/0.1.0/reference/m3-generic-clone-core/) adds one reusable non-handle IR operation
...
The enclosing #278 candidate now also contains the [exact indexed clone/Vec adapters](/reference/compiler/0.1.0/reference/m3-generic-vec-operations/),
[private generic signatures and calls](/reference/compiler/0.1.0/reference/m3-generic-function-operations/), and
[opaque typed handle slots](/reference/compiler/0.1.0/reference/m3-opaque-handle-slots/). These add focused source/hostile-IR,
...
The [indexed source matrix](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_INDEXED_SOURCE_OPERATIONS.md) and
[transient access/lexical binding contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_TRANSIENT_INDEXED_ACCESS.md) distinguish
...
The [indexed acceptance mapping](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_INDEXED_SOURCE_OPERATIONS.md#indexed-borrowing-acceptance-reconciliation-255256)
