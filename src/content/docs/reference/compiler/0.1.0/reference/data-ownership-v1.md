...
current public profile; see [the public profile](/reference/compiler/0.1.0/reference/m3-public-profile/) for supported
...
[`AGGREGATE_LAYOUT_V1.md`](/reference/compiler/0.1.0/reference/aggregate-layout-v1/). This slice has no heap,
...
[`OWNERSHIP_RUNTIME_V1.md`](/reference/compiler/0.1.0/reference/ownership-runtime-v1/). No target may expose a Rust `String`,
