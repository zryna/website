...
slug: "reference/compiler/0.1.0/reference/m2-native-mir"
---

> Verified compiler source: [docs/M2_NATIVE_MIR.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M2_NATIVE_MIR.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.

# M2 verified native MIR

Status: implemented as a separate internal lowering and mandatory raw-to-verified trust boundary.
The downstream [M2 Linux x86-64 native backend](/reference/compiler/0.1.0/reference/m2-native-backend/) now consumes this authority
...
The separate [M2 native backend](/reference/compiler/0.1.0/reference/m2-native-backend/) now provides audited Linux x86-64 object
emission, Boolean wrappers, internal calls, and typed link/run evidence. The explicit profile and
[manifest v2](/reference/compiler/0.1.0/reference/m2-manifest-v2/) and the independent
[three-target conformance gate](/reference/compiler/0.1.0/reference/m2-conformance/) are implemented. Issue #57 records authenticated
