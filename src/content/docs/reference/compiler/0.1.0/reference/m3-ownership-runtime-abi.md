...
slug: "reference/compiler/0.1.0/reference/m3-ownership-runtime-abi"
---

> Verified compiler source: [docs/M3_OWNERSHIP_RUNTIME_ABI.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_OWNERSHIP_RUNTIME_ABI.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
[`OWNERSHIP_RUNTIME_V1.md`](/reference/compiler/0.1.0/reference/ownership-runtime-v1/). Later issues must independently
