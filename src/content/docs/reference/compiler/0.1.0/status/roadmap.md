...
[M0 conformance gate](/reference/compiler/0.1.0/status/m0-conformance/). The same fail-closed gate passed locally and in required
...
[M0 conformance](/reference/compiler/0.1.0/status/m0-conformance/).
...
[scalar control-flow and modules v1](/reference/compiler/0.1.0/reference/control-flow-modules-v1/) contract and a
...
Issue #49 implements the internal [straight-line M2 semantic boundary](/reference/compiler/0.1.0/reference/m2-straight-line-semantics/).
Issue #50 extends it with [canonical control-flow semantics](/reference/compiler/0.1.0/reference/m2-control-flow-semantics/), definite
state, reachability, and return analysis. Issue #51 implements the internal
[deterministic JavaScript backend](/reference/compiler/0.1.0/reference/m2-javascript-backend/) over opaque verified views. Issue #52
implements the internal [direct core WebAssembly backend](/reference/compiler/0.1.0/reference/m2-webassembly-backend/) over the same
...
[verified native MIR profile](/reference/compiler/0.1.0/reference/m2-native-mir/), including deterministic lowering and an independent
raw-to-verified CFG, call, symbol, Boolean, ABI, dominance, and resource boundary. Issue #54 adds
the internal [M2 Linux x86-64 native backend](/reference/compiler/0.1.0/reference/m2-native-backend/): deterministic Cranelift object
...
[`zryna-manifest-v2.json`](/reference/compiler/0.1.0/reference/m2-manifest-v2/), and one create-only atomic transaction. `I32V1`,
...
is defined by the authenticated [M2 conformance gate](/reference/compiler/0.1.0/reference/m2-conformance/) and required `m2` CI
...
with manifest v3. [Public support and exclusions](/reference/compiler/0.1.0/reference/m3-public-profile/) and the
[beginner guide](/reference/compiler/0.1.0/reference/m3-getting-started/) are exported in the authenticated documentation bundle.
...
[`M3_BORROWING_SEMANTICS.md`](/reference/compiler/0.1.0/reference/m3-borrowing-semantics/). Issue #113 freezes the contract and
...
[indexed source contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M3_INDEXED_SOURCE_OPERATIONS.md#indexed-borrowing-acceptance-reconciliation-255256).
...
[`spec/wit/CAPABILITY_PROFILES_V1.md`](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/wit/CAPABILITY_PROFILES_V1.md): exact
...
The M4 [cross-target composition decision](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/language/CROSS_TARGET_PROFILES_V1.md),
...
the [minimal core and host library decision](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/libraries/MINIMAL_CORE_HOST_V0.md)
...
[JS/WASM adapter contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/interop/JS_WASM_ADAPTERS_V1.md): separate browser/Node ESM
and WIT/Component conversions, resource lifetimes, failure cleanup and interface versioning.
Its [consumer proof plan](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/interop/JS_WASM_ADAPTER_CONFORMANCE_V1.md) separates later
...
Issue #168 specifies the repository-only [package and release contract v1](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/package/PACKAGE_RELEASE_V1.md):
...
Issue #360 specifies the draft [package-instance identity contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/package/PACKAGE_INSTANCE_IDENTITY_V1.md):
...
[`spec/package/RESOLVED_BUILD_PLAN_V0.md`](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/package/RESOLVED_BUILD_PLAN_V0.md). It specifies
...
v0](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/package/SOURCE_TRUST_V0.md): explicit source/namespace and cache integrity,
...
The proposed [semantic query and snapshot contract](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/tooling/SEMANTIC_QUERIES_V1.md)
...
1. [#419](https://github.com/zryna/zryna/issues/419) freezes the
   [preview support and release policy](/reference/compiler/0.1.0/reference/developer-preview/), including exact advertised and
