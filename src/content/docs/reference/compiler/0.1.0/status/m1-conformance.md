...
slug: "reference/compiler/0.1.0/status/m1-conformance"
---

> Verified compiler source: [docs/M1_CONFORMANCE.md](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/docs/M1_CONFORMANCE.md) at commit `f4d28002a014cd2e717eba4e59764bd925bef8c1`.
...
The versioned [`m1-conformance-v1.json`](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/tests/m1-conformance-v1.json) registry freezes one
...
| Typed Boolean host normalization                   | [`scalar-v1-fixtures.json`](https://github.com/zryna/zryna/blob/f4d28002a014cd2e717eba4e59764bd925bef8c1/spec/abi/scalar-v1-fixtures.json) | `m1_bool_host_normalization_matches_without_enabling_bool_source` plus component-owned ABI tests | ABI carrier contract only                            |
