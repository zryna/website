...
> Verified compiler source: [docs/M3_PUBLIC_PROFILE.md](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M3_PUBLIC_PROFILE.md) at commit `4c9fbda9ca80decf755fb8313474217e051eb5c8`.
...
The [beginner guide](/reference/compiler/next/reference/m3-getting-started/) contains complete sources tied to the fixed executable
corpus. The detailed [language contract](/reference/compiler/next/reference/data-ownership-v1/),
[source-completion evidence](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M3_SOURCE_COMPLETION.md), and
[conformance contract](/reference/compiler/next/reference/m3-conformance/) distinguish source/IR proofs from executed target cases.
...
and fail at their owning phase. The [full gate](/reference/compiler/next/reference/m3-conformance/) retains exact-limit and
