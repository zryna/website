...
> Verified compiler source: [docs/M3_SHARED_WEAK_AUTHORITY.md](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M3_SHARED_WEAK_AUTHORITY.md) at commit `4c9fbda9ca80decf755fb8313474217e051eb5c8`.
...
[evidence and integration matrix](/reference/compiler/next/reference/m3-shared-weak-evidence/). It enables no runtime, backend,
driver route, public profile, or target execution.

The normative authorities remain [data ownership](/reference/compiler/next/reference/data-ownership-v1/),
especially sections 2, 5–7, 10–12, and
[ownership runtime ABI](/reference/compiler/next/reference/ownership-runtime-v1/), especially sections 2–3 and 7–8.
...
the [evidence matrix](/reference/compiler/next/reference/m3-shared-weak-evidence/). These interfaces add no source route, wire
