...
> Verified compiler source: [docs/M2_NATIVE_BACKEND.md](https://github.com/zryna/zryna/blob/b5be0a8e14cd45f40597f3028e9a38bd4c0bc510/docs/M2_NATIVE_BACKEND.md) at commit `b5be0a8e14cd45f40597f3028e9a38bd4c0bc510`.
...
[manifest v2](/reference/compiler/next/reference/m2-manifest-v2/). Issue #56 implements the fixed three-target oracle and required
[aggregate gate](/reference/compiler/next/reference/m2-conformance/). Issue #57 records authenticated website import, deployment,
