...
> Verified compiler source: [docs/M2_CONTROL_FLOW_SEMANTICS.md](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M2_CONTROL_FLOW_SEMANTICS.md) at commit `4c9fbda9ca80decf755fb8313474217e051eb5c8`.
...
snapshot described by [M2 module closure](/reference/compiler/next/reference/m2-module-closure/). It owns name and exact-type
...
profile. The internal [M2 JavaScript backend](/reference/compiler/next/reference/m2-javascript-backend/) executes these exact
conditions without truthiness, and the [M2 core WebAssembly backend](/reference/compiler/next/reference/m2-webassembly-backend/)
...
separately. The [M2 native MIR profile](/reference/compiler/next/reference/m2-native-mir/) and
[M2 Linux x86-64 native backend](/reference/compiler/next/reference/m2-native-backend/) now implement independent lowering,
target-specific verification, audited object emission, and bounded typed execution. The explicit
profile and [manifest-v2 transaction](/reference/compiler/next/reference/m2-manifest-v2/) are implemented by Issue #55. The
independent [fixed-oracle three-target gate](/reference/compiler/next/reference/m2-conformance/) is implemented by Issue #56. Issue
