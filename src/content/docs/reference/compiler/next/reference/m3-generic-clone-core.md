...
> Verified compiler source: [docs/M3_GENERIC_CLONE_CORE.md](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M3_GENERIC_CLONE_CORE.md) at commit `4c9fbda9ca80decf755fb8313474217e051eb5c8`.

# Generic non-handle structural clone core

This bounded Issue #278 operation implements the reusable clone part of
[C1–C4](/reference/compiler/next/reference/m3-ownership-composition/). It does not close #278, provide #255/#256 indexed source
...
after its signed bounds check; see [generic Vec operations](/reference/compiler/next/reference/m3-generic-vec-operations/).
