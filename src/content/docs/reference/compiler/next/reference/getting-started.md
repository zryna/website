...
> Verified compiler source: [docs/GETTING_STARTED.md](https://github.com/zryna/zryna/blob/b5be0a8e14cd45f40597f3028e9a38bd4c0bc510/docs/GETTING_STARTED.md) at commit `b5be0a8e14cd45f40597f3028e9a38bd4c0bc510`.
...
[accepted control flow](/reference/compiler/next/reference/m2-control-flow-semantics/#accepted-control-flow) and
[module rules](/reference/compiler/next/reference/m2-module-closure/) before extending the example.
...
use the unambiguous form `--arg=i32:-1`. The [CLI reference](/reference/compiler/next/reference/cli/) defines canonical spelling,
...
symlinks/reparse points in the checkout. The [strict workspace contract](https://github.com/zryna/zryna/blob/b5be0a8e14cd45f40597f3028e9a38bd4c0bc510/docs/STRICT_WORKSPACE.md)
...
The authoritative [target/platform table](/reference/compiler/next/reference/cli/#targets) documents JavaScript and core WebAssembly
...
See [the existing alternative-target commands](/reference/compiler/next/reference/cli/#examples) and platform prerequisites before
...
internal ownership tests do not enable that CLI profile. Consult the [roadmap](/reference/compiler/next/status/roadmap/) for
