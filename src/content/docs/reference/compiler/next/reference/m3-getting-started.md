...
> Verified compiler source: [docs/M3_GETTING_STARTED.md](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M3_GETTING_STARTED.md) at commit `4c9fbda9ca80decf755fb8313474217e051eb5c8`.
...
Run commands from the compiler repository root. See [public boundaries](/reference/compiler/next/reference/m3-public-profile/).

## Setup

Follow the [checkout and tool installation steps](/reference/compiler/next/reference/getting-started/#prepare-the-checkout):
...
syntax and ownership combinations fail closed. The [public profile](/reference/compiler/next/reference/m3-public-profile/) gives
host/toolchain and resource boundaries; [conformance](/reference/compiler/next/reference/m3-conformance/) describes the independent
oracles and exact-limit proofs. The [M1/M2 guide](/reference/compiler/next/reference/getting-started/) remains valid unchanged.
