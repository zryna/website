...
> Verified compiler source: [docs/M2_JAVASCRIPT_BACKEND.md](https://github.com/zryna/zryna/blob/8461e2677b397a4cda4431197b4b2ff17237cdf4/docs/M2_JAVASCRIPT_BACKEND.md) at commit `8461e2677b397a4cda4431197b4b2ff17237cdf4`.
...
[the separate sealed backend contract](/reference/compiler/next/reference/m2-webassembly-backend/). The
[M2 native MIR profile](/reference/compiler/next/reference/m2-native-mir/) and
[M2 Linux x86-64 native backend](/reference/compiler/next/reference/m2-native-backend/) now independently reseal and execute the
same verified authority. The explicit-profile driver and
[manifest-v2 transaction](/reference/compiler/next/reference/m2-manifest-v2/) and the independent
