...
> Verified compiler source: [docs/FRONTENDS.md](https://github.com/zryna/zryna/blob/b5be0a8e14cd45f40597f3028e9a38bd4c0bc510/docs/FRONTENDS.md) at commit `b5be0a8e14cd45f40597f3028e9a38bd4c0bc510`.
...
[Syntax protocol v2](https://github.com/zryna/zryna/blob/b5be0a8e14cd45f40597f3028e9a38bd4c0bc510/docs/SYNTAX_PROTOCOL_V2.md).
...
[M2 deterministic module closure](/reference/compiler/next/reference/m2-module-closure/) and specified normatively in
[scalar control flow and modules v1](/reference/compiler/next/reference/control-flow-modules-v1/). The public driver
...
[M2 straight-line semantic boundary](/reference/compiler/next/reference/m2-straight-line-semantics/) and
[control-flow extension](/reference/compiler/next/reference/m2-control-flow-semantics/), then the sealed internal
[M2 JavaScript backend](/reference/compiler/next/reference/m2-javascript-backend/) or
