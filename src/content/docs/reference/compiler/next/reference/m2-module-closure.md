...
> Verified compiler source: [docs/M2_MODULE_CLOSURE.md](https://github.com/zryna/zryna/blob/0b80816b7bca4d619c4716f1f15c993b30edb613/docs/M2_MODULE_CLOSURE.md) at commit `0b80816b7bca4d619c4716f1f15c993b30edb613`.
...
[M2 straight-line semantic boundary](/reference/compiler/next/reference/m2-straight-line-semantics/) and its
[control-flow extension](/reference/compiler/next/reference/m2-control-flow-semantics/), then the internal
[M2 JavaScript backend](/reference/compiler/next/reference/m2-javascript-backend/),
[M2 core WebAssembly backend](/reference/compiler/next/reference/m2-webassembly-backend/), or the independently resealed
[M2 Linux x86-64 native backend](/reference/compiler/next/reference/m2-native-backend/) only through the explicit driver path.
[Manifest v2 and the atomic multi-file command](/reference/compiler/next/reference/m2-manifest-v2/) and the independent
[fixed-oracle three-target gate](/reference/compiler/next/reference/m2-conformance/) are implemented. Issue #57 records authenticated
