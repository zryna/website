...
> Verified compiler source: [docs/M1_CONFORMANCE.md](https://github.com/zryna/zryna/blob/90615aecbbdc27836bbed3992d6736909f82ab58/docs/M1_CONFORMANCE.md) at commit `90615aecbbdc27836bbed3992d6736909f82ab58`.
...
The versioned [`m1-conformance-v1.json`](https://github.com/zryna/zryna/blob/90615aecbbdc27836bbed3992d6736909f82ab58/tests/m1-conformance-v1.json) registry freezes one
...
| Typed Boolean host normalization                   | [`scalar-v1-fixtures.json`](https://github.com/zryna/zryna/blob/90615aecbbdc27836bbed3992d6736909f82ab58/spec/abi/scalar-v1-fixtures.json) | `m1_bool_host_normalization_matches_without_enabling_bool_source` plus component-owned ABI tests | ABI carrier contract only                            |
