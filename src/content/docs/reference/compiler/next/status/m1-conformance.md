...
> Verified compiler source: [docs/M1_CONFORMANCE.md](https://github.com/zryna/zryna/blob/ecc6abbabe384558b55df1427267aada7d4a376e/docs/M1_CONFORMANCE.md) at commit `ecc6abbabe384558b55df1427267aada7d4a376e`.
...
The versioned [`m1-conformance-v1.json`](https://github.com/zryna/zryna/blob/ecc6abbabe384558b55df1427267aada7d4a376e/tests/m1-conformance-v1.json) registry freezes one
...
| Typed Boolean host normalization                   | [`scalar-v1-fixtures.json`](https://github.com/zryna/zryna/blob/ecc6abbabe384558b55df1427267aada7d4a376e/spec/abi/scalar-v1-fixtures.json) | `m1_bool_host_normalization_matches_without_enabling_bool_source` plus component-owned ABI tests | ABI carrier contract only                            |
