...
> Verified compiler source: [docs/M1_CONFORMANCE.md](https://github.com/zryna/zryna/blob/97eb9c8b64f9e534ad76de996c2eece85a25f729/docs/M1_CONFORMANCE.md) at commit `97eb9c8b64f9e534ad76de996c2eece85a25f729`.
...
The versioned [`m1-conformance-v1.json`](https://github.com/zryna/zryna/blob/97eb9c8b64f9e534ad76de996c2eece85a25f729/tests/m1-conformance-v1.json) registry freezes one
...
| Typed Boolean host normalization                   | [`scalar-v1-fixtures.json`](https://github.com/zryna/zryna/blob/97eb9c8b64f9e534ad76de996c2eece85a25f729/spec/abi/scalar-v1-fixtures.json) | `m1_bool_host_normalization_matches_without_enabling_bool_source` plus component-owned ABI tests | ABI carrier contract only                            |
