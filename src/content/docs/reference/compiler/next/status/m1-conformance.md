...
> Verified compiler source: [docs/M1_CONFORMANCE.md](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/docs/M1_CONFORMANCE.md) at commit `4c9fbda9ca80decf755fb8313474217e051eb5c8`.
...
The versioned [`m1-conformance-v1.json`](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/tests/m1-conformance-v1.json) registry freezes one
...
| Typed Boolean host normalization                   | [`scalar-v1-fixtures.json`](https://github.com/zryna/zryna/blob/4c9fbda9ca80decf755fb8313474217e051eb5c8/spec/abi/scalar-v1-fixtures.json) | `m1_bool_host_normalization_matches_without_enabling_bool_source` plus component-owned ABI tests | ABI carrier contract only                            |
